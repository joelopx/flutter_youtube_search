  ...
  Iterable<Object> serialize(Serializers serializers, Thumbnails object,
    ...
    final result = <Object>[
      ...
      serializers.serialize(object.medium,
          specifiedType: const FullType(Thumbnail)),
      'hight',
      serializers.serialize(object.hight,
          specifiedType: const FullType(Thumbnail)),
    ];
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'medium':
          ...
          break;
        case 'hight':
          result.hight.replace(serializers.deserialize(value,
              specifiedType: const FullType(Thumbnail)) as Thumbnail);
          break;
      }
    }
...
class _$Thumbnails extends Thumbnails {
  ...
  _$Thumbnails._({this.default_, this.medium, this.hight}) : super._() {
    ...
    if (hight == null) {
      throw new BuiltValueNullFieldError('Thumbnails', 'hight');
    }
  }
  ...
  int get hashCode {
    return $jf(
        $jc($jc($jc(0, default_.hashCode), medium.hashCode), hight.hashCode));
  }
...
class ThumbnailsBuilder implements Builder<Thumbnails, ThumbnailsBuilder> {
  ...
  ThumbnailBuilder _hight;
  ThumbnailBuilder get hight => _$this._hight ??= new ThumbnailBuilder();
  set hight(ThumbnailBuilder hight) => _$this._hight = hight;
